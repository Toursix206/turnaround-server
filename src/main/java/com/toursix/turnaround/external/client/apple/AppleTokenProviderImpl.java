...
public class AppleTokenProviderImpl implements AppleTokenProvider {
    ...
    public String getSocialIdFromIdToken(String idToken) {
        ...
        try {
            Map<String, String> header = objectMapper.readValue(
                    new String(Base64.getDecoder().decode(headerIdToken), StandardCharsets.UTF_8),
                    new TypeReference<>() {
                    });
            ...
            throw new UnAuthorizedException(
                    ...
                    UNAUTHORIZED_INVALID_SOCIAL_TOKEN_EXCEPTION);
    ...
    private PublicKey getPublicKey(Map<String, String> header)
        ...
        ApplePublicKeyResponse.Key key = response.getMatchedPublicKey(header.get("kid"),
                header.get("alg"));
