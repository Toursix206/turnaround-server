...
public class UserRetrieveController {
    ...
    @ApiOperation(value = "[인증] 마이 페이지 - 마이페이지 설정 상태를 조회합니다.")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "마이페이지 설정 조회 성공입니다."),
    ...
    public ResponseEntity<SuccessResponse<MyPageSettingResponse>> getMyPageSetting(@ApiIgnore @UserId Long userId) {
        return SuccessResponse.success(SuccessCode.GET_MYPAGE_INFO_SUCCESS,
