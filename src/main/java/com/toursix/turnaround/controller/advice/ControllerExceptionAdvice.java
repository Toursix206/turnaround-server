...
public class ControllerExceptionAdvice {
    ...
    /**
     * 400 BadRequest Pageable에 허용하지 않는 정렬기준이 입력된 경우 발생하는 Exception
     */
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ...
    /**
     * 405 Method Not Allowed 지원하지 않은 HTTP method 호출 할 경우 발생하는 Exception
     */
    ...
    /**
     * 415 UnSupported Media Type 지원하지 않는 미디어 타입인 경우 발생하는 Exception
     */
